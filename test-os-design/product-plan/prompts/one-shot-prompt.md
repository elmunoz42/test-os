...
3. **Data storage** — How the Test OS workspace state (phase completions, oracle data, run results) should be persisted
4. **Hermes integration** — How the Hermes validation executor is invoked and how results are read back
